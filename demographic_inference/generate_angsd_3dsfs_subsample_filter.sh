...
POPLIST="/data/scc3/anater/poplists/poplist.Midas.kautt.coverage.txt"

POPS=("Man_cit" "Nic_cit" "Mas_cit")
NIND=10
MININD_PROP=0.8
MINCOVERAGE=5
...
# estimate the 3d sfs:
$BIN/misc/realSFS ${POPS[0]}.${CHROMOSOME}.saf.idx ${POPS[1]}.${CHROMOSOME}.saf.idx ${POPS[2]}.${CHROMOSOME}.saf.idx -P 4 > $OUTFOLDER/${POPS[0]}_${POPS[1]}_${POPS[2]}.${CHROMOSOME}.sfs
